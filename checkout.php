                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td>Ksh<?php //echo LANG_VALUE_1; ?><?php echo $arr_cart_p_current_price[$i]; ?></td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                Ksh<?php //echo LANG_VALUE_1; ?><?php echo $row_total_price; ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount">Ksh<?php //echo LANG_VALUE_1; ?><?php echo $table_total_price; ?></th>
                        </tr>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td colspan="7" class="total-text">Ksh<?php //echo LANG_VALUE_84; ?></td>
                            <td class="total-amount">Ksh<?php //echo LANG_VALUE_1; ?><?php echo $shipping_cost; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                Ksh<?php //echo LANG_VALUE_1; ?><?php echo $final_total; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
	                	...
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form class="mpesa" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
